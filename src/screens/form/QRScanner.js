...
import {Text, View, TouchableOpacity, SafeAreaView, Button, Alert, Pressable} from "react-native";
...
const QRScanner = () => {
    ...
    const askForCameraPermission = async () => { // Made askForCameraPermission an async function
