...
export default {
  ...
  ChangePasswordScreen: {
    ...
    PasswordUpdateError: "An error occurred while updating the password. Please try again!",
  },
  ...
  ForgotPasswordScreen: {
    ...
    Description: "Enter your email address, and we will send you a link for getting back into your account.",
...
StatsPage:{
  ...
  Detailviews:{
    product:"Was the product missing from the Uptainer?"
