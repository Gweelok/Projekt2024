...
const UptainerTaskList = ({ location }) => {
  const dataTest = [
    "Is the Uptainer undamaged?",
    "Is the Uptainer clean?",
    "Is the Uptainer organized?",
  ];
  ...
  handlePressConfirm = () => {
    const answersToDatabase = createTaskAnswersData(
      newData,
      location.uptainerId
    );
        ...
        {newData.map((cur) => (
          <View style={styleLocal.row}>
            <View style={styleLocal.textBox}>
              <Text style={styles.article_text}>{cur.name}</Text>
            </View>
            <View style={styleLocal.row}>
              <TouchableOpacity
                ...
                style={[
                  styleLocal.buttons,
                  cur.pressedYes === true ? styleLocal.buttonPressedY : "",
                ]}
              >
                <Text
                  style={[
                    styles.article_text,
                    cur.pressedYes === true ? styleLocal.textPressed : "",
                  ]}
                >
                  Y
                </Text>
              ...
              <TouchableOpacity
                ...
                style={[
                  styleLocal.buttons,
                  cur.pressedNo === true ? styleLocal.buttonPressedN : "",
                ]}
              >
                <Text
                  style={[
                    styles.article_text,
                    cur.pressedNo === true ? styleLocal.textPressed : "",
                  ]}
                >
                  N
                </Text>
